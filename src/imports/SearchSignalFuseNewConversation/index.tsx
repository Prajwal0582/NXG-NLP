import svgPaths from "./svg-w9bibh0v4z";
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="menu_black_48dp 1">
      <svg className="absolute block inset-0 size-full" fill="none" height="24" preserveAspectRatio="none" viewBox="0 0 24 24" width="24">
        <g clipPath="url(#clip0_0_98)" id="menu_black_48dp 1">
          <g id="Vector" />
...
function Text() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#344054] text-[12px] whitespace-nowrap">3 of 3 free prompts left</p>
    </div>
  );
}
...
function PromptCounter() {
  return (
    <div className="bg-[#f0f9ff] content-stretch flex gap-[10px] items-center px-[12px] py-[6px] relative rounded-[16777200px] shrink-0" data-name="PromptCounter">
      <div aria-hidden className="absolute border border-[#bae6fd] border-solid inset-0 pointer-events-none rounded-[16777200px]" />
      <Icon />
      <Text />
      <Container />
    </div>
    ...
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Normal state">
      <div className="relative shrink-0 size-[16px]" data-name="">
        <svg className="absolute block inset-0 size-full" fill="none" height="16" preserveAspectRatio="none" viewBox="0 0 16 16" width="16">
          <path d={svgPaths.p2c5b6600} fill="url(#paint0_linear_0_88)" id="ï¢" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_88" x1="8" x2="8" y1="-6" y2="22">
...
function Frame33() {
  return (
    <div className="h-[13px] relative shrink-0 w-[15px]">
      <div className="absolute inset-[0_0_-588.46%_0]">
        <svg className="block size-full" fill="none" height="89.5" preserveAspectRatio="none" viewBox="0 0 15 89.5" width="15">
          <g id="Frame 1000002534">
            <g id="Frame 1000002533">
              <rect fill="url(#paint0_linear_0_82)" height="13" rx="6.5" width="13" x="2" />
              <circle cx="8.5" cy="6.5" fill="url(#paint1_linear_0_82)" id="Ellipse 3" r="2" />
            </g>
            <line id="Line 1" stroke="url(#paint2_linear_0_82)" x1="8.5" x2="8.5" y1="13.5" y2="89.5" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_82" x1="2" x2="16.1815" y1="1.10794" y2="2.99022">
              <stop stopColor="#FDECFB" />
              <stop offset="0.3" stopColor="#DAE1FF" />
              <stop offset="0.7" stopColor="#DAE1FF" />
              <stop offset="1" stopColor="#FDECFB" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_0_82" x1="6.5" x2="10.8628" y1="4.84265" y2="5.4211">
              <stop stopColor="#F599ED" />
              <stop offset="0.3" stopColor="#016DEE" />
              <stop offset="0.7" stopColor="#016DEE" />
              <stop offset="1" stopColor="#2DFBF9" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_0_82" x1="7.5" x2="7.5" y1="13.5" y2="89.5">
              <stop offset="0.682692" stopColor="#016DEE" />
...
function Frame30() {
  return (
    <div className="content-stretch flex gap-[12px] items-start relative shrink-0 w-[90px]">
      <div className="relative shrink-0 size-[16px]" data-name="Icons">
        <div className="[word-break:break-word] absolute flex flex-col font-['Font_Awesome_6_Pro:Regular',sans-serif] inset-0 justify-center leading-[0] not-italic text-[#475467] text-[16px] text-center tracking-[0.48px] uppercase">
          <p className="leading-[24px]">Code</p>
        </div>
      </div>
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[#344054] text-[12px] whitespace-nowrap">Executing Query</p>
    </div>
  );
}
...
function Frame31() {
  return (
    <div className="border border-[#d0d5dd] border-solid content-stretch flex items-start px-[24px] py-[12px] relative rounded-[8px] shrink-0 w-full">
      <Frame30 />
    </div>
  );
}
