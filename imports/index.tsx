import svgPaths from "./svg-p8vdx7zkya";
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="menu_black_48dp 1">
      <svg className="absolute block inset-0 size-full" fill="none" height="24" preserveAspectRatio="none" viewBox="0 0 24 24" width="24">
        <g clipPath="url(#clip0_0_95)" id="menu_black_48dp 1">
          <g id="Vector" />
    ...
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full" data-name="Normal state">
      <div className="relative shrink-0 size-[16px]" data-name="">
        <svg className="absolute block inset-0 size-full" fill="none" height="16" preserveAspectRatio="none" viewBox="0 0 16 16" width="16">
          <path d={svgPaths.p2c5b6600} fill="url(#paint0_linear_0_123)" id="ï¢" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_0_123" x1="8" x2="8" y1="-6" y2="22">
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="16" preserveAspectRatio="none" viewBox="0 0 16 16" width="16">
        <g id="Icon">
          <path d="M4 6L8 10L12 6" id="Vector" stroke="#475467" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Text12() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#475467] text-[14px] whitespace-nowrap">1.</p>
    </div>
  );
}
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="16" preserveAspectRatio="none" viewBox="0 0 16 16" width="16">
        <g id="Icon">
          <path d={svgPaths.p12a93580} id="Vector" stroke="#016DEE" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Link() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Link">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#016dee] text-[14px] whitespace-nowrap">Total count of Texas restaurants with more than 20 employees</p>
    </div>
  );
}
...
function Text13() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#475467] text-[14px] whitespace-nowrap">2.</p>
    </div>
  );
}
...
function Link1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Link">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#016dee] text-[14px] whitespace-nowrap">Texas restaurants with more than 20 employees</p>
    </div>
  );
}
...
function ListItem7() {
  return (
    <div className="content-stretch flex gap-[8px] h-[30px] items-start pt-[10px] relative shrink-0 w-[1002px]" data-name="List Item">
      <Text13 />
      <IconMargin1 />
      <Link1 />
    </div>
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col h-[62px] items-start pt-[12px] relative shrink-0 w-[1002px]" data-name="Container">
      <ListItem6 />
      <ListItem7 />
    </div>
  );
...
function Container2() {
  return (
    <div className="content-stretch flex flex-col h-[102px] items-start pt-[20px] relative shrink-0 w-[1002px]" data-name="Container">
      <Button1 />
      <Container3 />
    </div>
  );
...
function Icon4() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="16" preserveAspectRatio="none" viewBox="0 0 16 16" width="16">
        <g clipPath="url(#clip0_0_120)" id="Icon">
  ...
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="14" preserveAspectRatio="none" viewBox="0 0 14 14" width="14">
        <g id="Icon">
          <path d={svgPaths.p3e3ae080} id="Vector" stroke="#F59E0B" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
        </g>
      </svg>
    </div>
  );
...
function Paragraph4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] not-italic relative shrink-0 text-[#92400e] text-[0px] whitespace-nowrap">
        <span className="leading-[16px] text-[12px]">1 free prompt remaining.</span>
        <span className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] text-[12px]">{` Upgrade anytime for unlimited access.`}</span>
      </p>
    </div>
  );
}

function LastChanceWarning() {
  return (
    <div className="bg-[#fffbeb] border border-[#fde68a] border-solid content-stretch flex gap-[8px] items-center px-[12px] py-[8px] relative rounded-[8px] shrink-0 w-full" data-name="LastChanceWarning">
      <Icon9 />
      <Paragraph4 />
    </div>
  );
...
function TextInput() {
  return (
    <div className="content-stretch flex flex-[784.891_0_0] flex-col h-[20px] items-start justify-center min-w-px overflow-clip relative" data-name="Text Input">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#98a2b3] text-[14px] w-full">Ask me to refine, expand or narrow your lead list...</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="12" preserveAspectRatio="none" viewBox="0 0 12 12" width="12">
        <g id="Icon">
          <path d={svgPaths.p24e68700} id="Vector" stroke="#92400E" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </svg>
    </div>
  );
...
function Text15() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#92400e] text-[12px] whitespace-nowrap">1 of 4 free prompt left</p>
    </div>
  );
}

function Container14() {
  return <div className="bg-[#f59e0b] h-[6px] relative rounded-[16777200px] shrink-0 w-[21.328px]" data-name="Container" />;
}
...
function PromptCounter() {
  return (
    <div className="bg-[#fffbeb] border border-[#fde68a] border-solid content-stretch flex gap-[10px] items-center px-[12px] py-[6px] relative rounded-[16777200px] shrink-0" data-name="PromptCounter">
      <Icon13 />
      <Text15 />
      <Container13 />
    </div>
...
function Container12() {
  return (
    <div className="content-stretch flex h-[38px] items-center justify-between pt-[8px] relative shrink-0 w-[1030px]" data-name="Container">
      <Paragraph5 />
      <PromptCounter />
    </div>
  );
...
function Container7() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[8px] relative shrink-0 w-[1031px]" data-name="Container">
      <LastChanceWarning />
      <ContainerMargin />
      <Container12 />
    </div>
